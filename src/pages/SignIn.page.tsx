        ...
        <Center style={{ height: '100vh' }}>
            <Card shadow="xl" padding="xl" radius="md" withBorder style={{ width: rem(500) }}>
                <form onSubmit={form.onSubmit(({ email, password }) => handleSubmit(email, password))}>
                    ...
                    <Text size="sm" style={{ opacity: '0.4' }}>Please fill the input below</Text>
                    ...
                    <Group justify="flex-end" gap="xs" style={{ marginTop: rem(40) }}>
                        <Text size="sm" style={{ opacity: '0.4' }}>Don't hava an account?</Text>
                        <Link to="/sign-up">
                            <Text size="sm" c="teal" style={{ textDecoration: 'underline' }}>Sign up</Text>
                        </Link>
                    </Group>
                </form>
            </Card>
